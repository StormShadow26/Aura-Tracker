...
const clientid="386790249267-pu3n40nnoq8ojuc8q64vl48su1e1ndt9.apps.googleusercontent.com"
...
app.get(
  ...
  (req, res) => {
    ...
    res.redirect(`http://localhost:3000/dashboard?email=${encodeURIComponent(req.user.email)}`);
  }
);
